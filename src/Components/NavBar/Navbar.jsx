...
// import logo2 from "../../assets/images/نــو ه (1).png";
        ...
        >
          ...
          {userr && isload && <Dropdown placement="bottom-left">
            ...
            <Dropdown.Menu color="success" aria-label="User Actions">
              ...
              {/* <Dropdown.Item key="user-email" css={{ height: "$18" }} withDivider>
                <Text b color="inherit" css={{ d: "flex" }}>
                  {user?.email}
                </Text>
              </Dropdown.Item> */}
          ...
          {farmerr && isload && <Dropdown placement="bottom-left">
            ...
            <Dropdown.Menu color="success" aria-label="User Actions">
              ...
              {/* <Dropdown.Item key="farmer-email" css={{ height: "$18" }} withDivider>
                <Text b color="inherit" css={{ d: "flex" }}>
                  {Farmers?.email}
                </Text>
              </Dropdown.Item> */}
